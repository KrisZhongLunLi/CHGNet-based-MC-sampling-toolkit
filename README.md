...
### ▸ Input files:
**Input_CHGNet** : ![Required](https://img.shields.io/badge/Required-red). If this file is not present, the program will generate a template and then terminate execution.
